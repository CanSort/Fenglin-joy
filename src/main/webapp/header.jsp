        ...
        <div class="clearfix" id="top"><h1 class="fl"><a href="indexServlet"><img alt="" src="img/logo.png"/></a></h1>
            <div class="fr clearfix" id="top1">
                ...
                <p class="fl" style="padding-right: 15px;">
                    <img src="${pageContext.request.contextPath}/upload/user/${name.user_photo}"
                         style="width: 30px; border-radius: 45px;vertical-align: middle;">
                ...
                <div class="btn fl clearfix"><a href="toUserInfoServlet"><img src="img/grzx.png"/></a><a href="#"
                                                                                                         class="er1"><img
                        src="img/ewm.png"/></a>
                    <a href="toCartServlet"><img src="img/gwc.png"/></a>
                    <a href="logoutServlet"><img src="img/exit.png"></a>
