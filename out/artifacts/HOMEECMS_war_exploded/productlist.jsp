...
<div class="address">
    <div class="wrapper clearfix"><a
            href="indexServlet">首页</a><span>/</span>${fatherC.category_name}<span>/</span>${childC.category_name}</div>
</div><!-------------------current---------------------->
<div class="current">
...
<div class="proDets"><img class="off" src="images/temp/off.jpg"/>
    ...
    <div class="proCon clearfix">
        <div class="proImg fl"><img class="list" src="images/temp/proDet.jpg"/>
            <div class="smallImg clearfix"><img src="images/temp/proDet01.jpg"
                                                data-src="images/temp/proDet01_big.jpg"><img
                    src="images/temp/proDet02.jpg" data-src="images/temp/proDet02_big.jpg"><img
                    src="images/temp/proDet03.jpg"
        ...
        <div class="fr">
            <div class="proIntro"><p>颜色分类</p>
                <div class="smallImg clearfix categ"><p class="fl"><img src="images/temp/prosmall01.jpg"
                                                                        alt="白瓷花瓶+20支快乐花"
                    ...
                    <p class="fl"><img src="images/temp/prosmall03.jpg" alt="20支快乐花"
                                       data-src="images/temp/proBig03.jpg"></p>
                    <p class="fl"><img src="images/temp/prosmall04.jpg" alt="20支兔尾巴草"
                                       data-src="images/temp/proBig04.jpg"></p>
                </div>
